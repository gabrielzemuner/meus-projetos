...
export default function Create() {
  return (
    <AppLayout>
      ...
      <MainHeader title="Cadastrar" subtitle="Serviço">
          ...
          <div className="flex flex-col gap-2">
            <div className="grid grid-cols-1 gap-x-16 gap-y-2 lg:grid-cols-2">
              <div>
                ...
                <Input id="name" name="name" type="text" placeholder="Nome do serviço" className="mt-1" />
                {errors.name && <span className="text-red-600">{errors.name}</span>}
              </div>
              <div>
                <Label htmlFor="description">Descrição</Label>
                <Input id="description" name="description" type="text" placeholder="Descrição do serviço" className="mt-1" />
